...
<div style="background-color:#e9e3db; width:100%; padding:30px 0 100px 0; height:100%;">
    <div style="margin:0 auto; width:100%; max-width:620px; background-color: #fff;-webkit-border-radius: 20px;
        ...
        <div style="padding:0px 40px; text-align:justify; color:#666; line-height:150%; font-family:'Roboto','Helvetica',Arial,sans-serif; font-size:13px;">
            ...
            <!-- Content -->
            <h2 style=" color: #222;">Seu pedido foi <strong style="color:#b06758;">Efetuado com Sucesso</strong>!</h2>
            <p>Clique no botão abaixo para ver os detalhes.</p>
            <div style="width: 100%; padding: 40px 0; text-align: center;">
                <a href="{{ $orderUrl }}" style="background-color: #b06758; color: #fff; text-decoration: none; padding: 10px 20px;
                        font-size: 18px; font-weight: bold; -webkit-border-radius: 40px; -moz-border-radius: 40px; border-radius: 40px; margin:0 auto;">VER DETALHES</a>
            </div>
        </div>
