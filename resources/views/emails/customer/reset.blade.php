...
<div style="background-color:#e9e3db; width:100%; padding:30px 0 100px 0; height:100%;">
    <div style="margin:0 auto; width:100%; max-width:620px; background-color: #fff;-webkit-border-radius: 20px;
        ...
        <div style="padding:0px 40px; text-align:justify; color:#666; line-height:150%; font-family:'Roboto','Helvetica',Arial,sans-serif; font-size:13px;">
            <br><br>
            <!-- Tittle -->
            <h1 style="margin:0 0 30px 0; color:#222; font-size:18px; font-family:'Roboto','Helvetica',Arial,sans-serif; font-weight:900; text-transform: uppercase;">Olá.</h1>

            <!-- Content -->
            <p>Uma solicitação de alteração de senha foi feita na sua conta da <strong>{{ config('app.company.name') }}</strong>.</p>
            <p>Clique no botão abaixo para confirmar a alteração da sua senha.</p>
            <div style="width: 100%; padding: 40px 0; text-align: center;">
                <a href="{{ $actionUrl }}" style="background-color: #b06758; color: #fff; text-decoration: none; padding: 10px 20px;
                        font-size: 18px; font-weight: bold; -webkit-border-radius: 40px; -moz-border-radius: 40px; border-radius: 40px; margin:0 auto;">ALTERAR MINHA SENHA</a>
            </div>
            <p>Caso você não tenha solicitado esta alteração, basta desconsiderar este email.</p>
        </div>
