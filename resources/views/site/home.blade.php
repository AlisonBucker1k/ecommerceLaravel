                                                ...
                                                <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="300">
                                                    <div class="thumb">
                                                        <a href="/produto/ut-adipisci-sed-suscit-libero/20" class="image">
                                                            <img class="first-image" src="{{asset('useLadame/images/products/medium-size/5.jpg')}}" alt="Product" />
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <h5 class="title"><a href="produto/ut-adipisci-sed-suscipit-libero/20">{{$product->name}}</a></h5>
                                                        <span class="ratings">
                                ...
                                <div class="swiper-container">
                                    <div class="swiper-wrapper mb-n10">
                                        ...
                                        <div class="swiper-slide product-wrapper">
                                            ...
                                            @foreach ($products_promotion as $key => $product)
                                                <div class="product product-border-left mb-10" data-aos="fade-up" data-aos-delay="300">
                                                    <div class="thumb">
                                                        <a href="/produto/ut-adipisci-sed-suscit-libero/20" class="image">
                                                            <img class="first-image" src="{{asset('useLadame/images/products/medium-size/5.jpg')}}" alt="Product" />
